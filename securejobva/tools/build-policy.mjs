...
const TERMS = [
  ...
  '      <h2 id="t6">6. Social accounts and posting</h2>',
  "      <p>If you give us social media links or connect an account, you authorise us to view the associated profile and activity in order to assess your application.</p>",
  "      <p>Posting on your behalf is a separate permission and is never assumed. We ask for it explicitly, record the date and the exact wording you agreed to, and nothing is published to your accounts without it. You can withdraw it at any time &mdash; from <a href=\"/status\">your application page</a>, or by writing to <a href=\"mailto:support@securejobva.com\">support@securejobva.com</a>. Withdrawing does not erase the record of the permission that applied while it was in force.</p>",
...
const REFUNDS = [
  ...
  '      <h2 id="r2">2. Replacement rather than refund</h2>',
  ...
  "      <p>We prefer this to a refund because it solves the actual problem: a refund leaves you where you started, still short a person.</p>",

  '      <h2 id="r3">3. Billing and cancellation</h2>',
  ...
  '      <h2 id="r4">4. When we will not refund</h2>',
  "      <ul>",
  ...
  '      <h2 id="r5">5. Applicants are never charged</h2>',
  ...
  '      <h2 id="r6">6. Asking for a refund</h2>',
